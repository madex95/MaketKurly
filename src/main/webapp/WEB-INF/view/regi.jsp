...
<div class="page_aticle aticle_type2">
      <div id="snb" class="snb_cc">
        ...
        <div class="inner_snb">
            ...
            <li>
            <a href="https://www.kurly.com/shop/board/list.php?id=notice&amp;page=1#none" onclick="">1:1 문의</a>
            </li>
            <li>
  ...
  <div class="page_section section_qna">
    ...
    <div class="xans-board-write">
      <form name="fm" id="fm" method="post" action="/regi"  style="height: 100%;" enctype="multipart/form-data">
        <input type="hidden" name="mode" value="add_qna">
        <input type="hidden" name="itemcd" value="">
        <input type="hidden" name="sno" value="0">
        <input type="hidden" name="board_part" id="board_part" value="${board_part}">
        <table id="table_after" class="boardWrite2" width="100%">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <input type="text" id="board_title" name="board_title" style="width:100%" required="" fld_esssential="" label="제목" value="">
               </td>
            </tr>
            <tr>
              <th class="input_txt">작성자</th>
              <td>
                <input type="text" id="board_id" name="board_id" value="${principal.vo.user_id}" readonly="">
            ...
            <tr>
              ...
              <textarea id="board_content" name="board_content" style="width:100%;height:474px;" class="editing_area"  fld_esssential="" label="내용"></textarea>
              </td>
            </tr>
            <tr>
        ...
        <table width="100%">
          <tbody>
            <tr>
              ...
              <input onclick="lastCheck(this)" type="button"  class="bhs_button yb" value="저장" style="float:none;">
              </td>
            </tr>
          </tbody>
        </table>
  ...
  <script>
  var asd = $("#board_part").val();
  	if(asd == "question"){
  		$("#qna").html("- 1:1문의는 답변이 달리기 전까지만 수정/삭제 할 수 있습니다.");
  	}
  </script>
