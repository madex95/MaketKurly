        ...
        <script>	//카테고리 추가 유효성검사
			...
			function checkAddress(menu_address) { //메뉴 경로 검사
				...
				if (!checkExistData(menu_address, "메뉴 경로를")){
 				...
 				if(!byteCheck(menu_address,"메뉴 경로가",50)){
    				form.menu_address.focus();
					return false;
				}
				return true; //확인이 완료되었을 때
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	<form name="form" action="./updateSubMenu" method="post" onsubmit="return checkAll()">
					                <!-- SUBMENU CODE -->
					                <div>
					                    <h3 class="join_title">
					                ...
					                <div>
					                    ...
					                    <span class="box int_pass">
					                        <input type="text" name="menu_address" class="int" maxlength="50" value="${menu.menu_address}">
					                    </span>
					                    <span class="error_next_box"></span>
					                </div>
					                ...
					                <input type="hidden" value="${menu_code}" name="menu_parent">
					                <!-- ADD BTN-->
					                <div class="btn_area">
