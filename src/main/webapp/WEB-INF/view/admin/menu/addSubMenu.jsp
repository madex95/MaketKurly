                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	<form name="form" action="./insertSubMenu" method="post" onsubmit="return checkAll()">
					                <!-- SUBMENU CODE -->
					                <div>
					                    <h3 class="join_title">
					                ...
					                <div>
					                    ...
					                    <span class="box int_pass">
					                        <input type="text" name="menu_address" class="int" maxlength="50">
					                    </span>
					                    <span class="error_next_box"></span>
					                </div>
