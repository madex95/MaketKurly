                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	<div id="view">
	                            	배송비 : ${deliveryPrice }
	                            	<button type="button" onclick="changeInputBox()"class="btn btn-primary" style="background-color:#5f0080;border-color:#5f0080;">변경</button>
	                            	<button type="button" onclick="location.href='./deliveryHistory'"class="btn btn-primary" style="background-color:#5f0080;border-color:#5f0080;">이력 조회</button>
                            	</div>
                            	<div id="update" style="display:none">
                            		<form action="./changeDeliveryPrice" method="post" onsubmit="return check()">
	                            		배송비 : <input type="number" id="deliveryPrice" name="deliveryPrice" style="border:solid 1px #dadada;">
		                            	<button type="submit" class="btn btn-primary" style="background-color:#5f0080;border-color:#5f0080;">변경</button>
                            		</form>
                            	</div>
