    ...
    <head>
        ...
        <script>	// 유효성검사
			...
			function checkBoardTitle(board_title) { //제목 검사
 					...
 					if(!byteCheck(board_title,"제목이",2000)){
        				form.board_title.focus();
						return false;
					}
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	<form name="form" action="./insertBoard" method="post" onsubmit="return checkAll()" enctype="multipart/form-data">
                            		<input type="hidden" name="board_part" value="${code}">
					                <!-- BOARD_TITLE -->
					                <div>
					                    <h3 class="join_title">
					                    ...
					                    <span class="box int_id">
					                        <input type="text" name="board_title" class="int" maxlength="800">
					                    </span>
					                </div>
					                ...
					                <div>
					                    ...
					                    <span class="box int_name"style="height:300px;">
					                        <textarea name="board_content" class="int" maxlength="800" style="height:280px;"></textarea>
					                    </span>
					                </div>
