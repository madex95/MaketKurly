    ...
    <head>
        ...
        <script>	//권한 추가 유효성검사
			...
			function checkCode(code) { //권한 코드 검사
				//권한 코드가 입력되었는지 확인하기
				if (!checkExistData(code, "권한 코드가")){
    				form.code.focus();
    				return false;
				}
				if(!byteCheck(code,"권한 코드를",10)){
    				form.code.focus();
					return false;
				}
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
        				<div>
        				<button type="button" onclick="location.href='./grantabled?code=${code}'"class="btn btn-primary" style="background-color:#5f0080;border-color:#5f0080;float:right;">목록으로</button>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	<form name="form" action="./insertGrantAbled" method="post" onsubmit="return checkAll()">
					                
					                <!-- GRANT CODE -->
					                <div>
					                    <h3 class="join_title"><label for="pswd1">권한 코드</label></h3>
					                    <span class="box int_pass">
					                        <input type="text" name="code" class="int" maxlength="20">
					                        <input type="hidden" name="grant_code" value="${code}">
					                    </span>
