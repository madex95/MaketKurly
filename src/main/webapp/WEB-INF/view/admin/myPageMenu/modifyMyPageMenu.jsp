            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
        				<div>
        				<button type="button" onclick="location.href='./mypage'"class="btn btn-primary" style="background-color:#5f0080;border-color:#5f0080;float:right;">목록으로</button>
                        </div>
                        <h1 class="mt-4">마이페이지 메뉴 수정</h1><br>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	<form name="form" action="./updateMyPageMenu" method="post" onsubmit="return checkAll()">
					                <!-- MYPAGEMENU CODE -->
					                <div>
					                    <h3 class="join_title">
					                    ...
					                    <span class="box int_id">
					                        <label for="id">${myPage.menu_code}</label>
					                        <input type="hidden" name="menu_code" value="${myPage.menu_code}">
					                    </span>
					                ...
					                <div>
					                    ...
					                    <span class="box int_pass">
					                        <input type="text" name="menu_name" class="int" maxlength="30" value="${myPage.menu_name}">
					                    </span>
					                    <span class="error_next_box"></span>
					                </div>
					                ...
					                <!-- MYPAGEMENU ADDRESS -->
					                <div>
					                    <h3 class="join_title"><label for="pswd1">메뉴 경로</label></h3>
					                    <span class="box int_pass">
					                        <input type="text" name="menu_address" class="int" maxlength="20" value="${myPage.menu_address }">
					                    </span>
					                    <span class="error_next_box"></span>
					                </div>
