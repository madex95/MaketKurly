            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <h1 class="mt-4">마이페이지 메뉴 추가</h1><br>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	<form name="form" action="./insertMyPageMenu" method="post" onsubmit="return checkAll()">
					                <!-- MyPageMenu CODE -->
					                <div>
					                    <h3 class="join_title">
					                ...
					                <div>
					                    ...
					                    <span class="box int_pass">
					                        <input type="text" name="menu_address" class="int" maxlength="20">
					                    </span>
					                    <span class="error_next_box"></span>
					                </div>
