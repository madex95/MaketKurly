            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
        				<div>
        				<button type="button" onclick="location.href='./addMyPageMenu'"class="btn btn-primary" style="background-color:#5f0080;border-color:#5f0080;float:right;">메뉴 추가</button>
                        </div>
                    	<!-- 메뉴 이름 -->
											...
											<table class="table table-hover table-fixed" class="table_faq" id="faq_166">
												<tbody>
													<tr>
														...
														<td style="cursor:pointer"> ${Menu.menu_address}</td>
														<td style="cursor:pointer"><a href="./updateMyPageMenuAbled?menu_code=${Menu.menu_code}">${Menu.abled }</a></td>
														<td><a href='./modifyMyPage?menu_code=${Menu.menu_code}'>수정</a></td>
														<td><a href='./deleteMyPage?menu_code=${Menu.menu_code}'>삭제</a></td>
													</tr>
												</tbody>
											</table>
										</div>
