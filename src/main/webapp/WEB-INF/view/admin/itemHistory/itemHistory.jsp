                        ...
                        <div class="card mb-4">
                            ...
                            <!-- CODE -->
				                <div>
				                    ...
				                    <span class="box int_pass"style="display:inline;">
				                        <input type="text" name="item_code" class="int" maxlength="20" style="display:inline; width:87%;padding-right:20px;">
				                    </span>
				                    </h3>
				                </div>
                            ...
                            <!-- NAME -->
				                <div>
				                    ...
				                    <span class="box int_pass"style="display:inline;">
				                        <input type="text" name="item_name" class="int" maxlength="20" style="display:inline; width:87%;padding-right:20px;">
				                    </span>
				                    </h3>
				                </div>
