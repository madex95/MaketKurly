                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	<form name="form" action="./updateItem" method="post" onsubmit="return checkAll()" enctype="multipart/form-data">
					                <!-- ITEMCODE -->
					                <div>
					                    <h3 class="join_title">
					                ...
					                <div>
					                    ...
					                    <span class="box int_pass">
					                        <input type="text" name="item_name" class="int" maxlength="50" value="${item.item_name}">
					                    </span>
					                    <span class="error_next_box"></span>
					                </div>
					                ...
					                <div>
					                    ...
					                    <span class="box int_pass_check">
					                        <input type="number" name="item_price" class="int" value="${item.item_price}">
					                    </span>
					                    <span class="error_next_box"></span>
					                </div>
					                    ...
					                    <span class="box int_pass_check">
					                        <select name="item_cgcode">
					                        	<c:forEach items="${categoryNameList}" var="Category">
					                        		<c:choose>
						                        		<c:when test="${Category.code eq item.item_cgcode}">
					                ...
					                <div>
					                    ...
					                    <span class="box int_name">
					                        <input type="number" name="item_stock" class="int" maxlength="20" value="${item.item_stock}">
					                    </span>
					                    <span class="error_next_box"></span>
					                </div>
					                ...
					                <div>
					                    ...
					                    <span class="box int_name"style="height:300px;">
					                        <textarea name="item_detail" class="int" style="height:280px;">${item.item_detail}</textarea>
					                    </span>
					                    <span class="error_next_box"></span>
					                </div>
									...
									<div class="filebox">
									  ...
									  <span class="filetype">
									            <input type="hidden" id="board_image" name="board_images" class="file-text" value="${item.item_image }">
				            					<span id="board_image_id" class="file-text">${item.item_image }</span>
