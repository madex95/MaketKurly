...
<html lang="en">
    <head>
        ...
        <script>	//카테고리 추가 유효성검사
			...
			function checkCode(code) { //카테고리 코드 검사
        				//카테고리 코드가 입력되었는지 확인하기
       				 if (!checkExistData(code,"카테고리 코드를")){
          				form.code.focus();
      					 return false;
       				 }
					if(!byteCheck(code,"카테고리 코드가",10)){
        				form.code.focus();
						return false;
					}
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	<form name="form" action="./insertCategory" method="post" onsubmit="return checkAll()">
					                <!-- CATEGORY CODE -->
					                <div>
					                    <h3 class="join_title">
					                    ...
					                    <span class="box int_id">
					                        <input type="text" name="code" class="int" maxlength="10">
					                    </span>
