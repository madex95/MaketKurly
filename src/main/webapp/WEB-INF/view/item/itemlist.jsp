...
<ul class="list">
 <c:forEach items="${list2}" var="catelist" varStatus="status">
<li>
<div class="item">
<div class="thumb">
<a class="img" style="">
<img src="\resources\image\market\item\<fmt:formatDate value="${catelist.ori_date}" pattern="yyyy-MM-dd" />\<c:out value="${catelist.item_code}"/><c:out value="${fn:split(catelist.item_image,':')[0]}"/>" 
 width="388px" height="480px" alt="" onerror=""></a> 

</div> 
<a class="info">
 <a href="/itemdetail/<c:out value="${catelist.item_code}"/>">
<span class="name"><c:out value="${catelist.item_name }"/> </span>
</a> 
<span class="cost"><span class="price"><fmt:formatNumber value="${catelist.item_price}" pattern="#,### 원" /></span></span> 
    ...
    moveForm.submit();
       ...
       <c:if test="${pageMaker ne null }">
                    <div class="pageMaker_wrap" >
	                    ...
	                    <form id="moveForm" action="/itemlist/category" method="get">
